...
import 'entities/game_state/entity/game_state.dart';
import 'entities/match/entity/match.dart';
import 'entities/player/entity/player.dart';
import 'entities/round/entity/round.dart';
import 'entities/settings/entity/settings.dart';
import 'entities/user/entity/user.dart';
...
final _entities = <obx_int.ModelEntity>[
  ...
  obx_int.ModelEntity(
    ...
    name: 'Player',
    lastPropertyId: const obx_int.IdUid(24, 7571534865530513122),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
      ...
      obx_int.ModelProperty(
        id: const obx_int.IdUid(24, 7571534865530513122),
        name: 'startMove',
        type: 10,
        flags: 0,
      ),
  ...
  obx_int.ModelEntity(
    ...
    name: 'Settings',
    lastPropertyId: const obx_int.IdUid(5, 6233142382825515762),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
      ...
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 2937425182596156492),
        name: 'languageId',
        type: 6,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(5, 6233142382825515762),
        name: 'themeId',
        type: 6,
        flags: 0,
      ),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    Player: obx_int.EntityDefinition<Player>(
      ...
      objectToFB: (Player object, fb.Builder fbb) {
        ...
        fbb.addInt64(23, object.startMove?.millisecondsSinceEpoch);
        fbb.finish(fbb.endTable());
        return object.id;
      },
      objectFromFB: (obx.Store store, ByteData fbData) {
        final buffer = fb.BufferContext(fbData);
        final rootOffset = buffer.derefObject(0);
        final startMoveValue = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          50,
        );
        ...
        final startMoveParam = startMoveValue == null
            ? null
            : DateTime.fromMillisecondsSinceEpoch(startMoveValue);
    ...
    GameState: obx_int.EntityDefinition<GameState>(
      model: _entities[4],
      toOneRelations: (GameState object) => [
    ...
    Settings: obx_int.EntityDefinition<Settings>(
      ...
      objectToFB: (Settings object, fb.Builder fbb) {
        fbb.startTable(6);
        fbb.addInt64(0, object.id);
        fbb.addInt64(3, object.languageId);
        fbb.addInt64(4, object.themeId);
        fbb.finish(fbb.endTable());
        return object.id;
      },
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final themeIdParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          12,
          0,
        );
        final languageIdParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          10,
          0,
...
class Player_ {
  ...
  /// See [Player.startMove].
  static final startMove = obx.QueryDateProperty<Player>(
...
class Settings_ {
  ...
  /// See [Settings.languageId].
  static final languageId = obx.QueryIntegerProperty<Settings>(
    _entities[5].properties[1],
  );

  /// See [Settings.themeId].
  static final themeId = obx.QueryIntegerProperty<Settings>(
