...
class LightApplicationColors implements IApplicationColors {
  ...
  Color get primaryAccent =>
      const Color(0xFF2C3E50); // Тёмно-синий, как сукно бильярдного стола
  @override
  Color get secondaryAccent =>
      const Color(0xFFE74C3C); // Красный, как бильярдный шар
  @override
  Color get tertiaryAccent =>
      const Color(0xFF27AE60); // Зелёный, как сукно стола
